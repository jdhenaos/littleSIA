...
public class CrearSia {
	...
	///////////////////////////////////////////////////////////////////////
		...
		Carrera IngSistemas = new Carrera("Ingeniería Sistemas", 2879, IngSisIndBog);
		...
		Profesor profesor1_1 = new Profesor("Sara", "Gomez", fechaProfesor1_1, "Licenciado en Artes");
		
		Profesor profesor2 = new Profesor("Santiago", "Arias", 4552455,  fechaProfesor2, "Fisico", MatMed);
		Profesor profesor2_2 = new Profesor("Maria", "Rodriguez", 10256985, fechaProfesor2_2, "Licenciada en Lenguas Modernas", HistMed);
		...
		ArrayList<Grupo> gruposPOO = new ArrayList<Grupo>();
		...
		gruposPOO.add(grupoPOO1);
		gruposPOO.add(grupoPOO2);
		POO.setGrupos(gruposPOO);
		

		ArrayList<Grupo> gruposAlgLin = new ArrayList<Grupo>();
		...
		gruposAlgLin.add(grupoAlgLin1);
		gruposAlgLin.add(grupoAlgLin2);
		AlgLineal.setGrupos(gruposAlgLin);
		
		ArrayList<Grupo> gruposFotoII = new ArrayList<Grupo>();
		...
		gruposFotoII.add(grupoFotoII_1);
		gruposFotoII.add(grupoFotoII_2);
		FotoII.setGrupos(gruposFotoII);
		
		ArrayList<Grupo> gruposCat = new ArrayList<Grupo>();
		...
		gruposCat.add(grupoCatSigifEspinal);
		
		CatSigifEspinal.setGrupos(gruposCat);
		...
		ui.imprimirSede(sedes.get(a-1));
		
		
		int b  = peticion.nextInt();
		
		ui.imprimirFacultad(sedes.get(a-1).getFacultades().get(b-1));
		
	int c = peticion.nextInt();
		
		ui.imprimirDepartamento(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1));
		
		int d = peticion.nextInt();
		
	
		if( d == 1){
			System.out.print(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).listarCarreras());
			
			int e = peticion.nextInt();
			
			ui.imprimirCarrera(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).getCarreras().get(e-1));
			
		}else if(d == 2){
			System.out.print(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).listarProfesores());
			
			int e = peticion.nextInt();
			
			ui.imprimirProfesor(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).getProfesores().get(e-1));
			
		}else if(d == 3){
			System.out.print(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).listarCursos());
			
			int e = peticion.nextInt();
			
			ui.imprimirCurso(sedes.get(a-1).getFacultades().get(b-1).getDepartamentos().get(c-1).getCursos().get(e-1));
		}
